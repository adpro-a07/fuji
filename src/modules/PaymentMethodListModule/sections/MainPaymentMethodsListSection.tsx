...
export default function MainPaymentMethodsListSection({ paymentMethods }: { paymentMethods: PaymentMethodSummary[] }) {
    ...
    <div className="m-2 rounded-xl p-5">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
        {paymentMethods.length > 0 ? (
          ...
          <div className="col-span-4 py-10 text-center text-gray-500">No payment methods found</div>
        )}
      </div>
    </div>
  )
